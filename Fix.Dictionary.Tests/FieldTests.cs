...
namespace FixDictionary.Tests
{
    ...
    public class FieldTests
    {
        ...
        {
            Assert.IsNull(Dictionary.FIX_4_2.Fields[Dictionary.FIX_4_2.Fields.Length]);
        }
        ...
        {
            Assert.AreEqual(447, Fix.Dictionary.FIX_4_2.Fields.Length);
            Assert.AreEqual(957, Fix.Dictionary.FIX_4_4.Fields.Length);
            Assert.AreEqual(50003, Fix.Dictionary.FIX_5_0SP2.Fields.Length);
        }
